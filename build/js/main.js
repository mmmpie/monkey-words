(function () {
    ...
    if ("_" in globalScope)
        feature('libraries').lodash = globalScope._;
    if ("$" in globalScope)
        feature('libraries').jquery = globalScope.$;
    if ("Q" in globalScope)
        feature('libraries').promise = globalScope.Q;
    if ("document" in globalScope)
        feature('libraries').document = globalScope.document;
